...
| [04. `csv`](04-csv/README.es.md) | Controlar dialectos, quoting, forma de filas, semántica null, entrada malformada y límites de texto tabular | Intermedio | Disponible |
...
La Fase 8 está en progreso. El Capítulo 01 introduce [`pathlib`](01-pathlib/README.es.md), el Capítulo 02 añade [`datetime`](02-datetime/README.es.md), el Capítulo 03 profundiza [`json`](03-json/README.es.md), y el Capítulo 04 profundiza [`csv`](04-csv/README.es.md) con políticas explícitas de dialecto, quoting, forma de filas, null, errores, encoding y límites de recursos. El próximo capítulo planificado es `logging`.

Los Capítulos 03 y 04 revisitan `json` y `csv` a un nivel más profundo de biblioteca, mientras un capítulo posterior hará lo mismo con `logging`. Sus apariciones anteriores enseñaron formatos de archivo o conceptos más amplios de diseño; en esta fase estudiamos los módulos, sus APIs y sus trade-offs.
