...
| [04. `csv`](04-csv/README.md) | Control dialects, quoting, row shape, null semantics, malformed input, and tabular text boundaries | Intermediate | Available |
...
Phase 8 is in progress. Chapter 01 introduces [`pathlib`](01-pathlib/README.md), Chapter 02 adds [`datetime`](02-datetime/README.md), Chapter 03 deepens [`json`](03-json/README.md), and Chapter 04 deepens [`csv`](04-csv/README.md) with explicit dialect, quoting, row-shape, null, error, encoding, and resource-boundary policies. The next planned chapter is `logging`.
