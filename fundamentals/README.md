...
Continue with [Built-in Data Types](04-built-in-data-types/README.md). It explains values and types, source notation, `str`, `int`, `float`, `bool`, `None`, similar-looking values, and type-dependent behavior.
