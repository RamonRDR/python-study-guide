...
When `ndigits` is omitted or `None`, the result for built-in numeric values is an `int`:
...
Phase 2 is complete. Continue to the Phase 2 review checkpoint and then to **Phase 3: Collections** in the main roadmap.
