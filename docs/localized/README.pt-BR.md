...
As Fases 1, 2, 3, 4 e 6 estão concluídas. A Fase 5: Funções agora está em andamento com dois capítulos revisados: [Definindo e Chamando Funções](../../functions/01-defining-and-calling-functions/README.pt-BR.md) estabelece `def`, chamadas, reuso, ordem de execução, nomenclatura, `pass`, `None` implícito e a conexão com Fluxo do Programa; [Parâmetros e Argumentos](../../functions/02-parameters-and-arguments/README.pt-BR.md) adiciona parâmetros obrigatórios, argumentos posicionais, argumentos nomeados básicos, expressões como argumentos, erros comuns de chamada e rastreamento do fluxo de entrada. O próximo capítulo planejado de Funções é Valores de Retorno. A Fase 4 permanece concluída com oito capítulos revisados de Fluxo do Programa, encerrando com [Escolhendo e Combinando o Fluxo do Programa](../../program-flow/08-choosing-and-combining-program-flow/README.pt-BR.md). A Fase 3 reúne seis capítulos revisados de Coleções, encerrando com [Escolhendo a Coleção Certa](../../collections/06-choosing-the-right-collection/README.pt-BR.md). A Fase 2 permanece concluída com quatro capítulos revisados, encerrando com [Funções Numéricas Embutidas](../../strings-and-numbers/04-numeric-builtins/README.pt-BR.md). Consulte o [roadmap](../roadmap.pt-BR.md) ou a [trilha completa de estudos](../learning-path.pt-BR.md) para acompanhar o status do currículo e acessar os capítulos diretamente.
