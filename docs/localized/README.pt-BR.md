...
Cinco capítulos completos de aprendizagem estão disponíveis:
...
A Fase 6 continuará com legibilidade segundo a PEP 8. Consulte o [roadmap](../roadmap.pt-BR.md) para acompanhar o status de todas as fases.
