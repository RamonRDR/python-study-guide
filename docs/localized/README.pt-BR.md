...
A fundação do projeto e seis seções educacionais completas estão disponíveis. A [Fase 1: Fundamentos](../../fundamentals/README.pt-BR.md) oferece seis capítulos revisados para iniciantes. A Fase 6 reúne seis capítulos de aprendizagem revisados:
