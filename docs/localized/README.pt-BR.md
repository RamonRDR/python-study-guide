...
A fundação do projeto e sete seções educacionais completas estão disponíveis, e a [Fase 8: Biblioteca Padrão](../../standard-library/README.pt-BR.md) agora está em andamento com o [Capítulo 01: `pathlib`](../../standard-library/01-pathlib/README.pt-BR.md), o [Capítulo 02: `datetime`](../../standard-library/02-datetime/README.pt-BR.md), o [Capítulo 03: `json`](../../standard-library/03-json/README.pt-BR.md), o [Capítulo 04: `csv`](../../standard-library/04-csv/README.pt-BR.md), o [Capítulo 05: `logging`](../../standard-library/05-logging/README.pt-BR.md), o [Capítulo 06: `collections`](../../standard-library/06-collections/README.pt-BR.md) o [Capítulo 07: `itertools`](../../standard-library/07-itertools/README.pt-BR.md) e o [Capítulo 08: `decimal`](../../standard-library/08-decimal/README.pt-BR.md). A [Fase 7: Erros, Arquivos e Módulos](../../errors-files-and-modules/README.pt-BR.md) está concluída com cinco capítulos revisados. A [Fase 1: Fundamentos](../../fundamentals/README.pt-BR.md) oferece seis capítulos revisados para iniciantes. A Fase 6 reúne seis capítulos de aprendizagem revisados:
...
Contribuições, correções, exemplos e melhorias de tradução são bem-vindas. Leia o [guia de contribuição em português](CONTRIBUTING.pt-BR.md) antes de abrir um pull request. As versões em [inglês](../../CONTRIBUTING.md) e [espanhol](CONTRIBUTING.es.md) também estão disponíveis.
