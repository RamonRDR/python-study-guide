...
La base del proyecto y siete secciones educativas completas están disponibles, y la [Fase 8: Biblioteca Estándar](../../standard-library/README.es.md) está ahora en progreso con el [Capítulo 01: `pathlib`](../../standard-library/01-pathlib/README.es.md), el [Capítulo 02: `datetime`](../../standard-library/02-datetime/README.es.md), el [Capítulo 03: `json`](../../standard-library/03-json/README.es.md), el [Capítulo 04: `csv`](../../standard-library/04-csv/README.es.md), el [Capítulo 05: `logging`](../../standard-library/05-logging/README.es.md), el [Capítulo 06: `collections`](../../standard-library/06-collections/README.es.md) el [Capítulo 07: `itertools`](../../standard-library/07-itertools/README.es.md) y el [Capítulo 08: `decimal`](../../standard-library/08-decimal/README.es.md). La [Fase 7: Errores, Archivos y Módulos](../../errors-files-and-modules/README.es.md) está completada con cinco capítulos revisados. La [Fase 1: Fundamentos](../../fundamentals/README.es.md) ofrece seis capítulos revisados para principiantes. La Fase 6 reúne seis capítulos de aprendizaje revisados:
