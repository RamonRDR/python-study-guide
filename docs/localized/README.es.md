...
Las Fases 1, 2, 3, 4 y 6 están completadas. La Fase 5: Funciones está ahora en progreso con [Definir y Llamar Funciones](../../functions/01-defining-and-calling-functions/README.es.md), que introduce `def`, llamadas de funciones, reutilización, orden de ejecución, nombres, `pass`, `None` implícito y cómo las herramientas de flujo ya conocidas encajan dentro de los cuerpos de funciones. El siguiente capítulo planificado de Funciones es Parámetros y Argumentos. La Fase 4 permanece completada con ocho capítulos revisados de Flujo del Programa, terminando con [Elegir y Combinar el Flujo del Programa](../../program-flow/08-choosing-and-combining-program-flow/README.es.md). La Fase 3 reúne seis capítulos revisados de Colecciones, terminando con [Elegir la Colección Adecuada](../../collections/06-choosing-the-right-collection/README.es.md). La Fase 2 permanece completada con cuatro capítulos revisados, terminando con [Funciones Numéricas Incorporadas](../../strings-and-numbers/04-numeric-builtins/README.es.md). Consulta el [roadmap](../roadmap.es.md) o la [ruta completa de aprendizaje](../learning-path.es.md) para seguir el estado del currículo y acceder directamente a los capítulos.
