...
La Fase 8 está en progreso. El Capítulo 01 introduce objetos de ruta y límites del filesystem. El Capítulo 02 añade fechas, horas, duraciones, parsing, formato, datetimes naive frente a aware, offsets UTC fijos, conversión de timezone y cálculos de tiempo deterministas. El Capítulo 03 profundiza políticas de serialización y decodificación JSON, incluida salida determinista, manejo estricto de números no finitos, hooks numéricos, valores personalizados, nombres duplicados, diagnósticos y límites de recursos. El Capítulo 04 profundiza CSV como frontera de texto tabular con dialectos explícitos, quoting y escaping, política de forma de filas, parsing estricto, límites de campos, sniffing heurístico, fronteras de encoding y seguridad para consumidores de hojas de cálculo. El Capítulo 05 profundiza logging como un grafo de entrega de eventos en runtime con niveles efectivos, enrutamiento por handlers, propagación, `dictConfig()`, registros contextuales, atribución del llamador, entrega mediante colas, concurrencia y seguridad de configuración. El próximo capítulo planificado es **`collections`**.
