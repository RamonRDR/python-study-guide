...
Usa esta página como el **índice general del curso**. Todos los capítulos de aprendizaje ya publicados tienen un enlace directo aquí, para que puedas avanzar por la guía sin necesidad de abrir primero el índice de cada sección.

Si empiezas desde cero, sigue el orden de las fases. Algunas fases posteriores pueden estar completadas antes que fases anteriores todavía planificadas, pero la numeración sigue representando la secuencia de aprendizaje recomendada.

## Leyenda de estado

- ✅ **Disponible:** publicado y revisado
- 🚧 **En progreso:** la fase ya comenzó, pero todavía no está completa
- ⏳ **Planificado:** aún no disponible como sección completa de aprendizaje

## Fase 1 · Fundamentos ✅

[Abrir el índice de la sección Fundamentos](../fundamentals/README.es.md)

1. [Cómo Python ejecuta un programa](../fundamentals/01-how-python-runs-a-program/README.es.md)
2. [`print()` e `input()`](../fundamentals/02-print-and-input/README.es.md)
3. [Variables y nombres](../fundamentals/03-variables-and-naming/README.es.md)
4. [Tipos de datos incorporados](../fundamentals/04-built-in-data-types/README.es.md)
5. [`type()` e `isinstance()`](../fundamentals/05-type-and-isinstance/README.es.md)
6. [Conversión de tipos](../fundamentals/06-type-conversion/README.es.md)

## Fase 2 · Textos y Números ✅

[Abrir el índice de la sección Textos y Números](../strings-and-numbers/README.es.md)

1. [Creación e indexación de strings](../strings-and-numbers/01-string-creation-and-indexing/README.es.md)
2. [Métodos comunes de strings](../strings-and-numbers/02-common-string-methods/README.es.md)
3. [`int`, `float` y `bool`](../strings-and-numbers/03-int-float-and-bool/README.es.md)
4. [Funciones numéricas incorporadas](../strings-and-numbers/04-numeric-builtins/README.es.md)

## Fase 3 · Colecciones ✅

[Abrir el índice de la sección Colecciones](../collections/README.es.md)

1. [Creación, indexación y slicing de listas](../collections/01-list-creation-and-indexing/README.es.md)
2. [Modificar listas y métodos comunes](../collections/02-modifying-lists-and-methods/README.es.md)
3. [Tuplas e inmutabilidad](../collections/03-tuples-and-immutability/README.es.md)
4. [Diccionarios: claves y valores](../collections/04-dictionaries-keys-and-values/README.es.md)
...
1. [Comentarios en Python](../comments-and-documentation/01-comments/README.es.md)
2. [Docstrings en Python](../comments-and-documentation/02-docstrings/README.es.md)
3. [Nombres significativos y código autoexplicativo](../comments-and-documentation/03-meaningful-names/README.es.md)
4. [Marcadores de tareas y seguimiento técnico](../comments-and-documentation/04-task-markers/README.es.md)
...
4. [Controlando Dialectos CSV y Contratos de Texto Tabular](../standard-library/04-csv/README.es.md)
5. [Diseñando Pipelines de Logging y Contratos de Contexto en Runtime](../standard-library/05-logging/README.es.md)
...
7. ✅ [Flujo Ficticio de Conciliación](../practical-projects/07-fictional-reconciliation-workflow/README.es.md)
8. ✅ [Flujo Simulado de Automatización](../practical-projects/08-simulated-automation-flow/README.es.md)

La Fase 10 está completada con ocho proyectos prácticos revisados. El Proyecto 01 integra modelado de datos validado, dinero exacto con `Decimal`, colecciones, persistencia JSON, exportación CSV, manejo determinista de archivos temporales y cobertura automatizada con pytest. El Proyecto 02 añade políticas de calificación configurables, agregación ponderada exacta, estado de progreso frente a final explícito, informe estructurado y pruebas centradas en límites. El Proyecto 03 añade datos de identidad canónicos, normalización Unicode e IDNA, prevención de duplicados, índices secundarios de lookup, actualizaciones seguras de campos indexados, transiciones explícitas del ciclo de vida y pruebas centradas en mutación sin introducir autenticación. El Proyecto 04 añade ingestión CSV consciente de schema, conversión tipada, diagnóstico de rechazos por fila, fallos estructurales, comprobación de identificadores duplicados, filtros deterministas y agregación mediante la biblioteca estándar. El Proyecto 05 añade ventanas explícitas de informe, resúmenes deterministas, métricas exactas con dos decimales, límites inmutables del informe, renderización TXT/Markdown, escape específico del formato y escritura UTF-8. El Proyecto 06 añade descubrimiento superficial y determinista de archivos, clasificación por sufijo, planificación dry-run inmutable, políticas explícitas de colisión, fronteras de symlink, identidad `(device, inode)`, anclaje de raíz/categorías, nombres de staging acotados y commit atómico no-replace sensible a la plataforma con `renameat2(RENAME_NOREPLACE)` en Linux. El Proyecto 07 añade modelos inmutables de conciliación, aritmética exacta en centavos enteros, matching y orden deterministas, rechazo de duplicados, estados explícitos de conciliación, invariantes validadas del informe, renderizado de texto estable y cobertura de regresión para límites de precisión y seguridad. El Proyecto 08 añade solicitudes y resultados inmutables de automatización, un plan fijo de ejecución, logs deterministas de eventos, evidencia estructurada, inyección controlada de fallos, propagación fail-fast, semántica de pasos omitidos, reglas de publicación de salida y cobertura de regresión centrada en invariantes sin integraciones externas.

## Navegación útil

- [Página principal del repositorio](../README.md)
- [Roadmap completo](roadmap.es.md)
- [Estructura del proyecto](project-structure.es.md)

A medida que se publiquen nuevos capítulos, esta página debe actualizarse en el mismo pull request para que el curso siempre tenga una única ruta de navegación fiable y accesible con un clic.