...
- `practical-projects/`: Phase 10 practical-project workspace. Project 01, Expense Tracker, integrates validated data modeling, exact `Decimal` money, JSON persistence, CSV export, a deterministic demo, and automated pytest coverage.
