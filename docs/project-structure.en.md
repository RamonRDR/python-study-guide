...
- `comments-and-documentation/`: Phase 6 learning path. Complete chapters are available for comments, docstrings, and meaningful names, each in English, Brazilian Portuguese, and Spanish with safe executable examples.
