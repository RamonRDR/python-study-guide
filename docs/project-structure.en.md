...
- `assets/`: original project visual identity, including scalable sources and PNG exports for the banner and repository preview, the primary transparent logo, the compact logo mark, palette documentation, meaning, accessibility guidance, and usage rules.
