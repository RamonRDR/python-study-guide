...
- `standard-library/`: trilha da Fase 8 em andamento. O Capítulo 01 ensina objetos de caminho e fronteiras do filesystem com `pathlib`; o Capítulo 02 ensina modelagem de data/hora e cálculos determinísticos com `datetime`; o Capítulo 03 ensina contratos avançados com `json`; o Capítulo 04 ensina dialetos `csv`, quoting, validação do formato das linhas, semântica de null, encoding, tratamento de entrada malformada, heurísticas e limites de recursos, em inglês, português brasileiro e espanhol com exemplos executáveis determinísticos.
