...
| 10. Practical projects | In progress | Projects 01–07 are complete; Project 08 Simulated Automation Flow is in progress with deterministic orchestration, structured events and evidence, fail-fast propagation, and invariant-focused regression coverage |

Phases 0–9 are complete. Phase 10: Practical Projects is in progress with Projects 01–07 complete, while Simulated Automation Flow is the current and final planned Project 08. The practical-project phase turns previously studied concepts into complete workflows with requirements, design decisions, implementation, validation, extension paths, and portfolio discussion.
