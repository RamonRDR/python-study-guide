...
| 10. Practical projects | In progress | Projects 01–06 are complete; Project 07 Fictional Reconciliation Workflow is in progress with deterministic matching, exact monetary arithmetic, explicit reconciliation states, validated report invariants, and focused regression coverage |

Phases 0–9 are complete. Phase 10: Practical Projects is in progress with Expense Tracker, Grade Calculator, User Registration, CSV Analyzer, Report Generator, and File Organizer complete as Projects 01–06, while Fictional Reconciliation Workflow is the current Project 07. The practical-project phase turns previously studied concepts into complete workflows with requirements, design decisions, implementation, validation, extension paths, and portfolio discussion.
