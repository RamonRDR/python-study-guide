...
| 10. Practical projects | Complete | Projects 01–08 are complete and integrated, closing the phase with deterministic orchestration, structured events and evidence, fail-fast propagation, and invariant-focused regression coverage |

Phases 0–10 are complete. Phase 10: Practical Projects closes with all eight planned projects implemented, documented, tested, reviewed, and integrated. The practical-project phase turns previously studied concepts into complete workflows with requirements, design decisions, implementation, validation, extension paths, and portfolio discussion.
...
- [x] [Simulated Automation Flow](../practical-projects/08-simulated-automation-flow/README.md)
