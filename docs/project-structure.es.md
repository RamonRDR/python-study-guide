...
- `comments-and-documentation/`: ruta de la Fase 6. Hay capítulos completos sobre comentarios, docstrings y nombres significativos, cada uno en inglés, portugués de Brasil y español, con ejemplos ejecutables seguros.
