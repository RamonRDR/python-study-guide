...
- `assets/`: identidad visual original del proyecto, con fuentes escalables y exportaciones PNG para el banner y la vista previa del repositorio, logotipo principal transparente, símbolo compacto, documentación de la paleta, significados, orientaciones de accesibilidad y reglas de uso.
