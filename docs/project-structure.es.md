...
- `practical-projects/`: espacio de proyectos prácticos de la Fase 10. El Proyecto 01, Control de Gastos, integra modelado de datos validado, dinero exacto con `Decimal`, persistencia JSON, exportación CSV, una demo determinista y cobertura automatizada con pytest.
