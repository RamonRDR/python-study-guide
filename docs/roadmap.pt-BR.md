...
| 1. Fundamentos | Em andamento | Dois capítulos disponíveis: execução, saída e entrada do programa |
...
As Fases 0 e 6 estão concluídas. A Fase 6 estabeleceu o padrão editorial-piloto, e a Fase 1 agora está em andamento com dois capítulos disponíveis.
