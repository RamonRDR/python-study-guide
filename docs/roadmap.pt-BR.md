...
| 10. Projetos práticos | Concluída | Projetos 01–08 estão concluídos e integrados, encerrando a fase com orquestração determinística, eventos e evidências estruturados, propagação fail-fast e cobertura de regressão focada em invariantes |

As Fases 0–10 estão concluídas. A Fase 10: Projetos Práticos encerra com os oito projetos planejados implementados, documentados, testados, revisados e integrados. A fase transforma conceitos já estudados em fluxos completos com requisitos, decisões de design, implementação, validação, caminhos de extensão e discussão de portfólio.
...
- [x] [Fluxo Simulado de Automação](../practical-projects/08-simulated-automation-flow/README.pt-BR.md)
