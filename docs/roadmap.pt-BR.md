...
|---|---|---|
| 0. Fundação do projeto | Em andamento | Documentação principal, governança, autoria, licença, estrutura, templates de colaboração, padrões da comunidade e validações automáticas já estão disponíveis |
