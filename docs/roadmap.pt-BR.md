...
| 10. Projetos práticos | Em andamento | Projetos 01–06 estão concluídos; o Projeto 07 Fluxo Fictício de Conciliação está em andamento com matching determinístico, aritmética monetária exata, estados explícitos de conciliação, invariantes validadas de relatório e cobertura focada de regressão |

As Fases 0–9 estão concluídas. A Fase 10: Projetos Práticos está em andamento com Controle de Despesas, Calculadora de Notas, Cadastro de Usuários, Analisador CSV, Gerador de Relatórios e Organizador de Arquivos concluídos como Projetos 01–06, enquanto o Fluxo Fictício de Conciliação é o atual Projeto 07. A fase transforma conceitos já estudados em fluxos completos com requisitos, decisões de design, implementação, validação, caminhos de extensão e discussão de portfólio.
...
- [ ] [Fluxo Fictício de Conciliação](../practical-projects/07-fictional-reconciliation-workflow/README.pt-BR.md) - projeto atual
