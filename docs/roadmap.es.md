...
| 4. Flujo del programa | En progreso | Los Capítulos 01 y 02 cubren condiciones confiables, lógica booleana, pertenencia, identidad, `if`, `elif`, `else`, orden de ramas y decisiones independientes frente a exclusivas |
