...
| 10. Proyectos prácticos | En progreso | Los Proyectos 01–07 están completados; el Proyecto 08 Flujo Simulado de Automatización está en progreso con orquestación determinista, eventos y evidencias estructurados, propagación fail-fast y cobertura de regresión centrada en invariantes |

Las Fases 0–9 están completadas. La Fase 10: Proyectos Prácticos está en progreso con los Proyectos 01–07 completados, mientras que Flujo Simulado de Automatización es el Proyecto 08 actual y último planificado. La fase transforma conceptos ya estudiados en flujos completos con requisitos, decisiones de diseño, implementación, validación, caminos de extensión y discusión de portafolio.
