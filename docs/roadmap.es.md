...
| 5. Funciones | En progreso | Ocho capítulos revisados cubren `def`, llamadas, entradas obligatorias, valores retornados, alcance, type hints, valores predeterminados seguros, recolección flexible de argumentos posicionales y por palabra clave y composición de funciones |
...
Las Fases 0, 1, 2, 3, 4 y 6 están completadas. La Fase 5: Funciones está en progreso con definición, llamada, flujo de entrada, flujo de retorno, alcance, interfaces con type hints, comportamiento de valores predeterminados, recolección de cantidades variables de argumentos posicionales y por palabra clave y composición mediante funciones que cooperan ya establecidos; Flujo de Datos Entre Funciones es el siguiente paso. La Fase 6 continúa proporcionando el modelo editorial y de calidad para las secciones posteriores.
