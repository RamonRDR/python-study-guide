...
| 02. Modifying lists and common list methods | Change list contents deliberately and understand mutation | Beginner | Planned |
| 03. Tuples and immutability | Use immutable sequences and compare them with lists | Beginner | Planned |
...
Phase 3 is **in progress**. Chapter 01 is available in English, Brazilian Portuguese, and Spanish. Chapters 02 through 06 remain planned and will be added as complete, reviewable chapters rather than empty placeholders.
